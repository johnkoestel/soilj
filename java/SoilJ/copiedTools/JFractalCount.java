 ...
 * @author John Koestel (re-refactoring)
 * @see <p>
 *      <a
...
public class JFractalCount implements PlugIn {
	...
	public double[] count(ImagePlus imp) {

		double[] fractalAndFit = new double[2];
