...
public class ThreeDCalculator extends ImagePlus implements PlugIn  {
	...
	public void run(String arg) {
		...
		for (i = 0 ; i < myTiffs.length ; i++) {  //myTiffs.length
			...
			//load image
			nowTiffA = jIO.openTiff3D(myBaseFolderA + "\\" + myTiffs[i]);
			nowTiffB = jIO.openTiff3D(myBaseFolderB + "\\" + myTiffs[i]);
