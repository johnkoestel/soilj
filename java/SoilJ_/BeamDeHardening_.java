...
public class BeamDeHardening_ extends ImagePlus implements PlugIn  {
	...
	public void run(String arg) {
		...
		InputOutput.MyFolderCollection mFC = jIO.getAllMyNeededFolders(myBaseFolder, myTiffs, "", useInnerCircle, false);
		...
		for (i = 0 ; i < myTiffs.length ; i++) {  //myTiffs.length
			...
			outTiff = jIM.beamDeHardenThis(nowTiff, mFC.myInnerCircleFiles[myGandS[0]], mBDH);
