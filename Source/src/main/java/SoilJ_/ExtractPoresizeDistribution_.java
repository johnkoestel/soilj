...
public class ExtractPoresizeDistribution_ extends ImagePlus implements PlugIn  {
	...
	public void run(String arg) {
	    ...
	    while (myTiffs == null) {
	    	myBaseFolder = jIO.chooseAFolder("Please choose the folder with your thickness images");
