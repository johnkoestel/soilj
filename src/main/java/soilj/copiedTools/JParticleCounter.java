 ...
 * 
 */
public class JParticleCounter implements PlugIn, DialogListener {
	...
	public final static int GRADIENT = 0, SPLIT = 1;

	public String sPhase = "";

	public String chunkString = "";

	public int labelMethod = MAPPED;

	public void run(String arg) {}

	public void displayEllipsoids(Object[][] ellipsoids, Image3DUniverse univ) {
	...
	public Object[][] getEllipsoids(ArrayList<List<Point3f>> surfacePoints) {
	 ...
	 * @return
	 */
	public double[][] getEulerCharacter(ImagePlus imp, int[][] particleLabels,
	...
	public void display3DOriginal(ImagePlus imp, int resampling,
	...
	public void displayPrincipalAxes(Image3DUniverse univ,
	 ...
	 * @param title
	 */
	public void displayAxes(Image3DUniverse univ, double[] centroid,
	 ...
	 * @param univ
	 */
	public void displayCentroids(double[][] centroids, Image3DUniverse univ) {
	 ...
	 * 
	 */
	public void displayParticleSurfaces(Image3DUniverse univ,
	...
	public double[] getSurfaceArea(ArrayList<List<Point3f>> surfacePoints) {
		Iterator<List<Point3f>> iter = surfacePoints.iterator();
		...
		while (iter.hasNext()) {
			List<Point3f> points = iter.next();
			if (null != points) {
				double surfaceArea = JMeasureSurface.getSurfaceArea(points);					
	...
	public double[] getSurfaceVolume(ArrayList<List<Point3f>> surfacePoints) {
		Iterator<List<Point3f>> iter = surfacePoints.iterator();
	...
	public ArrayList<List<Point3f>> getSurfacePoints(ImagePlus imp,
		...
		for (int p = 0; p < nParticles; p++) {
			...
			if (p > 0) {
				...
				//points = mct.getTriangles(binaryImp, 128, channels, resampling);
	 ...
	 * @return
	 */
	public double[] getFerets(ArrayList<List<Point3f>> particleSurfaces) {
	 ...
	 */
	public void filterParticles(ImagePlus imp, byte[][] workArray,
	 ...
	 * @return
	 */
	public void minimiseLabels(int[][] particleLabels) {
	 ...
	 * @param d
	 */
	public void excludeOnEdges(ImagePlus imp, int[][] particleLabels,
			byte[][] workArray) {
		final int w = imp.getWidth();
		final int h = imp.getHeight();
		final int d = imp.getImageStackSize();
	 ...
	 */
	public int[][] firstIDAttribution(ImagePlus imp, final byte[][] workArray,
			final int phase) {
		final int w = imp.getWidth();
		final int h = imp.getHeight();
		final int d = imp.getImageStackSize();
	 ...
	 */
	public void connectStructures(ImagePlus imp, final byte[][] workArray,
	 ...
	 * @param particleLabels
	 */
	public void joinStructures(ImagePlus imp, int[][] particleLabels, int phase) {
		final int w = imp.getWidth();
		final int h = imp.getHeight();
		final int d = imp.getImageStackSize();
		long[] particleSizes = getParticleSizes(particleLabels);
	...
	public void joinMappedStructures(ImagePlus imp, int[][] particleLabels,
		...
		//IJ.showStatus("Snowballing and stuff ...");
	...
	public boolean checkConsistence(int[] lut, ArrayList<HashSet<Integer>> map) {
	...
	public boolean findFirstAppearance(int[] lut,
	...
	public boolean updateLUTwithMinPosition(int[] lut,
	...
	public boolean mergeDuplicates(ArrayList<HashSet<Integer>> map,
...
//								+ lutValue);
	 ...
	 */
	public boolean snowballLUT(final int[] lut,
			ArrayList<HashSet<Integer>> map, ArrayList<HashSet<Integer>> lutList) {
		// HashSet<Integer> set = null;
		// HashSet<Integer> target = null;
		boolean changed = false;
	 ...
	 * @param lutlist
	 */
	public void updateLUT(int oldValue, int newValue, int[] lut,
			ArrayList<HashSet<Integer>> lutlist) {
	 ...
	 * @return
	 */
	public int countDuplicates(int[] counter, ArrayList<HashSet<Integer>> map,
			int[] lut) {
	 ...
	 * @param lut
	 */
	public void addNeighboursToMap(ArrayList<HashSet<Integer>> map, int[] nbh,
			int centre) {
	...
	public void applyLUT(int[][] particleLabels, final int[] lut, final int w,
	...
	public boolean minimiseLutArray(int[] lutArray) {
	 ...
	 */
	public void get26Neighborhood(int[] neighborhood, final int[][] image,
	...
	public void get6Neighborhood(int[] neighborhood, final int[][] image,
			final int x, final int y, final int z, final int w, final int h,
			final int d) {
	 ...
	 */
	public int getPixel(final int[][] image, final int x, final int y,
	 ...
	 */
	public byte[][] makeWorkArray(ImagePlus imp) {
	 ...
	 */
	public int[][] getStitchRanges(ImagePlus imp, int nC, int slicesPerChunk) {
		final int nSlices = imp.getImageStackSize();
		if (nC < 2) {
			return null;
		}
	 ...
	 */
	public boolean withinBounds(int m, int n, int o, int w, int h, int startZ,
			int endZ) {
		return (m >= 0 && m < w && n >= 0 && n < h && o >= startZ && o < endZ);
	}

	public boolean withinBounds(final int m, final int n, final int o,
	 ...
	 */
	public int getOffset(int m, int n, int w) {
		return m + n * w;
	}
	 ...
	 *            titles
	 */
	public ImagePlus displayParticleLabels(int[][] particleLabels,
			ImagePlus imp) {
		final int w = imp.getWidth();
		final int h = imp.getHeight();
		final int d = imp.getImageStackSize();
